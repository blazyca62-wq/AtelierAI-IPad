...
1.68: Echter Fix der Mischvorschläge. chooseMixes benutzt jetzt tatsächlich mixingPaletteColors(): ab 2 markierten Farben nur eigene Auswahl, sonst automatisch vollständige gewählte Palette. Dadurch erscheinen nach Pipettenaufnahme wieder konkrete Mischrezepte.

1.69: Palettenwechsel im Mischbereich repariert. Nach Pipettenaufnahme bleibt die Zielfarbe erhalten; beim Wechsel zwischen den verfügbaren Paletten werden die Mischvorschläge sofort neu berechnet.

1.70: Mischbereich stabilisiert. Artisan, Horadam und Akademie sind im Palettenfeld jederzeit auswählbar. Der Palettenwechsel schaltet Öl/Aquarell automatisch passend um, ohne die Auswahl zu sperren, und berechnet vorhandene Pipetten-Zielfarben sofort neu. Punkt-, Kreis- und Smart-Pipette verwenden denselben Mischvorschlagsweg.
